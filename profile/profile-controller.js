/* Home Kitchen client profile — controller layer.
   STO 6.6: preserves client_api_profile and checkout profile reuse. */
(function(global){
  'use strict';
  ...
  function loadProfileModular(){
    ...
    global.HKProfileView.render(section(),{
      name:profile.name,
      phone:profile.phone,
      backendLabel:'Supabase Cloud'
    });
    return profile;
  }
  ...
  global.HKProfileController=Object.freeze({
    storageKey:STORAGE_KEY,
    load:loadProfileModular,
    save:saveProfileModular,
    get:getProfile
  });

  document.documentElement.dataset.hkProfileArchitecture='modular-v1';
  loadProfileModular();
})(window);